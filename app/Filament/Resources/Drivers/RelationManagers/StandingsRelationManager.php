...
/**
 * Championship {@see \App\Models\Standing} rows for a {@see \App\Models\Driver}.
 */
class StandingsRelationManager extends RelationManager
{
    protected static string $relationship = 'standings';

    protected static ?string $title = 'Championship standings';
    ...
    {
        return $table
            ->modifyQueryUsing(fn ($query) => $query->orderBy('rank')->with(['season']))
            ->recordTitleAttribute('season.title')
            ->columns([
